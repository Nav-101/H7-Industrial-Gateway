...
* **Integrated eFuse (TPS2596):** For secondary protection, a **TPS2596** (**U3**) provides programmable overvoltage (OVP) and undervoltage (UVLO) protection, along with precise current limiting to safeguard the internal rails.
